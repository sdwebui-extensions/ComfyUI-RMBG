...
class FashionSegmentClothing:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(folder_paths.cache_dir, "models/BiRefNet/segformer_fashion")):
            self.cache_dir = os.path.join(folder_paths.cache_dir, "models/BiRefNet/segformer_fashion")
        self.class_map = {
