...
class FaceSegment:
    def __init__(self):
        ...
        if os.path.exists(os.path.join(folder_paths.cache_dir, "models/BiRefNet/segformer_face")):
            self.cache_dir = os.path.join(folder_paths.cache_dir, "models/BiRefNet/segformer_face")
